...
declare -a noStrict=(
  ...
  "./generated/definitions/idpay https://raw.githubusercontent.com/pagopa/cstar-securehub-infra-api-spec/refs/tags/v2.13.1/src/idpay/apim/api/idpay_appio_full/openapi.appio.full.yml"
