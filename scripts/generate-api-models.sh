...
IO_SERVICES_METADATA_VERSION=1.0.88
...
declare -a noParams=(
  ...
  "./generated/definitions/content https://raw.githubusercontent.com/pagopa/io-services-metadata/refs/heads/IOCOM-2708-ff-aar-flow-phase-3/definitions.yml"
