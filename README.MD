...
- **understand flows and data echanged** between app and backend
...
1. install all packages needed:<br/>
   `yarn install`
1. generate all api-paths and models handled by [io-backend](https://github.com/teamdigitale/io-backend):<br/>
   `yarn generate:all`
