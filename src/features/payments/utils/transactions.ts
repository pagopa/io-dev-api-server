...
import { InfoTransaction, OriginEnum, PaymentMethodEnum } from "../../../../generated/definitions/pagopa/transactions/InfoTransaction";
...
export const generateRandomInfoTransaction = (transactionId?: string): InfoTransaction => {
  const randomPaymentMethod = faker.helpers.arrayElement(PAYMENT_METHODS_TRANSACTIONS_MOCK);
  return {
