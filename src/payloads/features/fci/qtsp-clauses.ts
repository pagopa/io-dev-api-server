...
export const qtspClauses: QtspClausesMetadataDetailView = {
  clauses: [
    ...
    {
      text: "Accetto le Condizioni Generali di [Contratto](https://docs.namirialtsp.com/documents/Mod_NAM_CA01D_ITA.pdf) (Mod.NAM CA01) e le clausole vessatorie riportate nel [Quadro F – Clausole vessatorie](@DOCUMENT_URL)"
    } as QtspClause
  ],
  document_url:
