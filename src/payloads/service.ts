...
export const getServiceMetadata = (
  ...
  const metaData: ServicePublicService_metadata = {
    ...
    scope: serviceScope,
    address: "Piazza di Spagna, indirizzo espanso, molto lungo lungo lungo Roma, Italia" as NonEmptyString,
    email: "emailemailemailemailemailemailemailemailemailemail@email.com" as NonEmptyString,
    pec: "pecemailpecemailpecemailpecemailpecemailpecemailpecemail@email.com" as NonEmptyString,
    phone: "55555555555  55555555555555555 55555  5555  555555  55555555   55555" as NonEmptyString,
    web_url: "https://www.googlegooglegooglegooglegooglegoogle.com" as NonEmptyString,
